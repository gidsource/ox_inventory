return {
	Weapons = {
		--addons
		['WEAPON_WHITEIRON'] = {
			label = 'White Iron Sword',
			weight = 0,
			durability = 0.03,
		},
		['WEAPON_WOLFGRAVESTONE'] = {
			label = 'Wolf Grave Stone',
			weight = 0,
			durability = 0.03,
		},
		['WEAPON_MIST_SPLITTER'] = {
			label = 'Mist Splitter',
			weight = 0,
			durability = 0.00,
		},
	...
	Ammo = {
		...
		['ammo-shotgun'] = {
			label = 'Ammo Shotgun 12 Gauge',
			weight = 38,
		},

		['ammo-sniper'] = {
			label = 'Sniper Ammo 7.62x51',
			weight = 9,
		},
